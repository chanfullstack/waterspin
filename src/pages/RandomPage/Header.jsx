            ...
            <nav className="bg-white py-2 md:py-4">
                <div className="container px-4 mx-auto md:flex md:items-center">
                    ...
                    <div className="flex justify-between items-center">
                        <a href="#" className="font-bold text-xl text-red-600" onClick={() => { navigate(`/`) }}>Food Recipe</a>
                    ...
                    <div className={menuToggle} id="navbar-collapse">
                        <a href="#" className="p-2 lg:px-4 md:mx-2 text-gray-600 rounded hover:bg-gray-200 hover:text-gray-700 transition-colors duration-300" onClick={() => { navigate(`/`) }}>Home</a>
                        <a href="#" className="p-2 lg:px-4 md:mx-2 text-white rounded bg-red-600">Random Menu</a>
